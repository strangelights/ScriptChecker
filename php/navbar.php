...
//
    ...
    '<nav>
        <ul class="topnav" id="topnav">
            ...
            <li>
                <a href="https://asta.rsglab.com/projects/biff/check.php">DNSChecker</a>
            </li>
            <li>
                <a href="https://asta.rsglab.com/projects/stuu/">EchoComm</a>
            </li>
            <li>
                <a href="https://asta.rsglab.com/projects/SpeedRacer/12monkeys/">S.T.A.R. Search</a>
            </li>
            <li>
